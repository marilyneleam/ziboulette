...
121 4 121 43 0 35 -21 45 -106 51 -70 6 -82 4 -104 -14z"
                ...
                <div className="hidden md:block order-last">
                    <Link
                        ...
                        className="inline-block font-primary border px-4 lg:px-7 py-3 lg:py-[17px] text-sm lg:text-base leading-[18px] bg-primary text-white border-transparent z-100 rounded-[30px] relative hover:shadow-[0_12px_24px_-6px_rgba(45,67,121,.1)] transition-all"
                    >
                        Ajouter une ziboulette
                    </Link>
                </div>
                ...
                >
                    <div className="px-4 py-3 space-y-2">
                        ...
                        <Link
                            href="/ajouter-ziboulette"
                            onClick={() => setNavOpen(false)}
                            className="block w-full text-center font-primary border px-7 py-[17px] leading-[18px] transition bg-primary text-white border-transparent rounded-[30px] hover:shadow-[0_12px_24px_-6px_rgba(45,67,121,.1)]"
                        >
                            Ajouter une ziboulette
                        </Link>
                    </div>

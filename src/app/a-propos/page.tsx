          ...
          <Box className="p-8">
              ...
              <Box className="bg-white rounded-xl shadow-lg p-8 mb-8">
                  ...
                  <p className="text-lg text-gray-700 mb-6">
                      ...
                      l&apos;actualité en la rendant accessible et
                      divertissante. Notre plateforme combine deux univers
                      uniques :
                  </p>
                  <ul className="space-y-4 ml-6 text-gray-700">
                      ...
                      <li className="flex items-start">
                          ...
                          Un espace communautaire pour partager vos ZIB
                          (Ziboulettes Incroyablement Bizarres)
                      </li>
                  </ul>
              </Box>
              ...
              <Box className="bg-white rounded-xl shadow-lg p-8 mb-8">
                  ...
                  <p className="text-lg text-gray-700 mb-4">
                      Notre approche unique combine information et
                      divertissement pour créer une expérience engageante :
                  </p>
                  <ul className="space-y-3 ml-6 text-gray-700">
                      ...
                      <li>
                          Une communauté active partageant leurs expériences
                          sous forme de ZIB
                      </li>
                      <li>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                      <div className="bg-zib-light-gray rounded-lg p-6 text-center hover:shadow-md transition-shadow duration-300">
                          ...
                          <p className="text-gray-700">
                              L&apos;information claire et compréhensible pour
                              tous
                          </p>
                      </div>
                      <div className="bg-zib-light-gray rounded-lg p-6 text-center hover:shadow-md transition-shadow duration-300">
              ...
              <Box className="bg-white rounded-xl shadow-lg p-8 mb-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      <div className="bg-zib-light-gray rounded-lg p-8 text-center hover:-translate-y-1 transition-transform duration-300">
                          ...
                          <p className="text-gray-700">
                              Expert en vulgarisation de l&apos;actualité,
                              Antony transforme l&apos;information complexe en
                              contenu accessible et engageant.
                          </p>
                      </div>
                      <div className="bg-zib-light-gray rounded-lg p-8 text-center hover:-translate-y-1 transition-transform duration-300">
                          <h3 className="text-2xl font-bold text-primary mb-2">
              ...
              <Box className="bg-white rounded-xl shadow-lg p-8 text-center">
                  ...
                  <p className="text-lg text-gray-700 mb-8">
                      ...
                      moments insolites, Ziboulette est votre nouvelle
                      destination quotidienne. Rejoignez notre communauté
                      grandissante et partagez vos propres ZIB !
                  </p>
                  <a
                      href="/"
